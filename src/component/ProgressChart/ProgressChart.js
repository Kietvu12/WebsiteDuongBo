  ...
  return (
    <div className="bg-white rounded-lg p-4 sm:p-3 xs:p-2">
      ...
      <div className="flex flex-col ml-10 md:flex-row items-center justify-center gap-4 md:gap-6 w-full">
        ...
        <div className="w-40 h-40 mr-8 md:w-36 md:h-36 sm:w-32 sm:h-32 xs:w-28 xs:h-28 flex items-center justify-center">
          <Doughnut data={dataChart} options={options} />
        </div>

        {/* Chú thích - chuyển thành grid 2 cột khi màn hình nhỏ */}
        <div className="grid grid-cols-2 mr-8 sm:ml-8 lg:ml-8 md:ml-8 5xl:ml-12 md:flex md:flex-col gap-2 w-full max-w-xs sm:max-w-full">
