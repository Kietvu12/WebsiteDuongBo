...
<div className="p-4">
  <div className="w-full">
    <div className="bg-white rounded shadow">
      {/* Header */}
      <div className="flex items-center gap-2 bg-gray-100 px-4 py-3 text-blue-700 font-semibold text-sm">
      ...
      <div
        ...
        onClick={() => handleSelect(projectData, 'project')}
      >
