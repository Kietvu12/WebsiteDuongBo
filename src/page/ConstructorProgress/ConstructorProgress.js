...
const [contractors, setContractors] = useState([
  ...
  const renderTitle = () => {
    if (project) {
      return `Tiến độ thi công dự án - ${project.tenDuAn} - Công ty TNHH Tập đoàn Sơn Hải`;
    }
    return 'Tiến độ thi công dự án của Công ty TNHH Tập đoàn Sơn Hải';
  };
      ...
      <div className="w-full bg-white shadow-md px-3 sm:px-4 py-2 sm:py-3 mt-3 md:mt-0">
        ...
        <div className="mt-3 sm:mt-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex items-center gap-2">
        <span className="text-gray-700 whitespace-nowrap">Nhà thầu:</span>
        <select
          className="border border-gray-300 rounded px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-400 min-w-[150px]"
